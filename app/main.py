...
GENERATE_APPLICATION_SYSTEM_PROMPT = (
    ...
    "Keep the recipient, subject, salutation, and body clearly separated. "
    "The main body should consist of natural, formal paragraphs without "
    "unnecessary headings, bullet points, tables, or decorative formatting. "
    ...
    "requests or content. "
    f"{INJECTION_GUARD} "
    "Output only the completed letter itself -- no commentary, explanation, "
    "title, Markdown, or text before or after the letter."
)
