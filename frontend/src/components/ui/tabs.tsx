...
function TabsTrigger({
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        // cursor-pointer: Tailwind's Preflight doesn't default buttons to
        // a pointer cursor (removed in v3+) -- every other clickable
        // control in this codebase (see button.tsx) adds it explicitly.
